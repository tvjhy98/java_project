...
public class Ex01 {
	// 제네닉과 컬렉션 (자료구조)
	// 제네닉 : 컬렉션이 어떤 객체들로 이루어져있는지를 표시하는 객체 타입을 말한다 
	// 컬렉션 : 객체들을 모아서 관리하는 인터페이스을 구현한것 
	// API    : <T> => 객체 타입, <E> => 요소 (컬렉션 안에 존재하는 객체 하나를 뜻한다) 
	// 		  	Map 형식에선는 <K, V> => Key(키), value (값)
	...
	// Collection 의 주요 메소드
	// add (E e ) : boolean => 해당 컬렉션에 객체 추가, 성공함ㄴ true, 실패하면 false 
	// addAll(Collection<? extends E> c) : boolean
	//		=> 특정 컬렉션에 있는 모든 요소들을 다른 컬렉션에 추ㅏ 
	// 	clear() : void => 모든 요소 삭제 
	...
	// 	iterator() : 	Iterator<E>
	// 		=> 컬렉션안에 요소들을 순서대로 접근하기 위한 Iterator 객체를 반환 
	//		=> 컬렉션안에 존재하는 요소들을 하나씩 꺼내서 작업할떄 사용한다 
