...
public class Ex08 {
	public static void main(String[] args) {
		...
		// 					Key는 중복될수 없다 (key가 중복되면 덮어쓰기 된다)
		//					value는 중복가능
		...
		// remove(object key) : 키를 받아서 
		// - replace(K key, V value) : 치환하기
		
		// 1. key를 순서 있는 숫자로 만들면 for문 사용가능
		...
		// 2. key를 문자로 만들면 출력시 keySet() 를 사용해야 된다 (일반적)
