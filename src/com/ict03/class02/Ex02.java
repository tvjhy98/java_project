...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.println(date.getDay());  // Calendar.get(Calendar.DAY_OF_WEEK) 요일(0=>일요일 ~ 6=> 토요일)
		
		System.out.println("===========================");
		
		// Calendar 클래스
		// 현재 날짜와 시간을 구할때는 new 예약어를 사용하지 않고 객체 생성
		// 년 월 일 시 분 초 구할때  Calendar.get(Calendar.get(Calendar.상수)를 사용
